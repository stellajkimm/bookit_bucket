...
categories = ["restaurants", "dates", "friends", "things to buy", "things to do", "before i die", "places to visit", "activities"]
...
bucket_titles = { "restaurants" => ["Places to Eat", "Restaurants", "Nomnoms", "Must Eat Here", "Delicious Places to Eat", "My Favorite Restaurants", "FOOD", "Get In My Belleh", "Eat Me", "Eat"],
						...
						"things to buy" => ["Things I Need", "Things To Buy", "Wish List", "Buy Me This", "Want List", "Presents For Me", "Presents", "Someone Buy Me This", "Give It To Me", "If I Had More Money", "When I Get A Job, I Will Buy..."],
						"things to do" => ["Things To Do", "Do This", "To Do", "Need To Be Done", "Ain't Nobody Got Time Fo Dat", "Do This Before Anything", "Get This Shit Done", "Do This Or Mom Will Kill You"],
						"before i die" => ["Actual Bucket List", "Things To Do Before I Die", "Before I Die", "Life Goals", "Kick The Bucket", "You Only Live Once", "YOLO"],
						"places to visit" => ["Must Go Here", "Places To Visit", "I Need To Go Here", "Can Someone Take Me Here?", "Who Wants to Go Here With Me?", "I Love These Places"],
